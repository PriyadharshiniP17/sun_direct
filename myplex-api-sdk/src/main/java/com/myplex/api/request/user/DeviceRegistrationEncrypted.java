...
public class DeviceRegistrationEncrypted extends APIRequest {
   ...
   // public static String DEVICE_REG_SALT2 = "@fd34d%d";
     ...
     */
    public DeviceRegistrationEncrypted(Activity mActivity, Params params, APICallback mListener) {
        super(mListener);
...
//        String serialNo = SDKUtils.getInstanceID(mActivity);
        ...
        final StringBuilder reqParams = new StringBuilder("serialNo=").append(serialNo)
                ...
                .append("&osVersion=").append(android.os.Build.VERSION.RELEASE)
        ...
        Call<DeviceRegData> registerDeviceAPICall = myplexAPIInstance.getInstance().myplexAPIService
                .registerDeviceEncryptedPayLoad(payload);
        registerDeviceAPICall.enqueue(new Callback<DeviceRegData>() {
            ...
            public void onResponse(Call<DeviceRegData> call, Response<DeviceRegData> response) {
                ...
                DeviceRegistrationEncrypted.this.onResponse(apiResponse);
            ...
            public void onFailure(Call<DeviceRegData> call, Throwable t) {
                ...
                if (t instanceof UnknownHostException
                    ...
                    DeviceRegistrationEncrypted.this.onFailure(t, ERR_NO_NETWORK);
                    return;
                }
                DeviceRegistrationEncrypted.this.onFailure(t, ERR_UN_KNOWN);
            }
