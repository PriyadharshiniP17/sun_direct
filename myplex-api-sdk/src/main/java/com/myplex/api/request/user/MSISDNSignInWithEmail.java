 ...
 */
public class MSISDNSignInWithEmail extends APIRequest {

    private static final String TAG = MSISDNSignInWithEmail.class.getSimpleName();
    ...
    public static class Params {
        ...
        public Params(String mobile, String emailID, String otp) {
            this.mobile = mobile;
    ...
    public MSISDNSignInWithEmail(Params params, APICallback mListener) {
        super(mListener);
        this.params = params;
    }
    ...
    protected void execute(myplexAPI myplexAPI) {
        ...
        Call<BaseResponseData> loginAPICall = myplexAPI.getInstance().myplexAPIService
                .signInWithMsisdnAndEmailIDRequest(params.mobile,
                        clientKey,
                        params.emailID,
                        params.otp,
        ...
        loginAPICall.enqueue(new Callback<BaseResponseData>() {
            ...
            public void onResponse(Call<BaseResponseData> call, Response<BaseResponseData> response) {
                ...
                MSISDNSignInWithEmail.this.onResponse(apiResponse);
            }
            ...
            public void onFailure(Call<BaseResponseData> call, Throwable t) {
                ...
                if (t instanceof UnknownHostException
                    ...
                    MSISDNSignInWithEmail.this.onFailure(t, ERR_NO_NETWORK);
                    return;
                }
                MSISDNSignInWithEmail.this.onFailure(t, ERR_UN_KNOWN);
            }
        });
