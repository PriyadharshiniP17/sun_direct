...
public class DraggableView extends RelativeLayout {
  ...
  private static final float DEFAULT_PLAYER_CLOSE_DRAG_OFFSET = 0.85f;
  ...
  private DraggableViewCallback mDraggableViewCallback;
  private boolean isFullScreen;
  private boolean minimized;

  public boolean checkMinimized() {
    return minimized;
  }

  public void setPlayerSeekbarView(View mPlayerSeekbarView) {
    this.mMediaControllerView = mPlayerSeekbarView;
  }
  ...
  public void setXTopViewScaleFactor(float xScaleFactor) {
    this.scaleFactorX = xScaleFactor;
  ...
  public void setYTopViewScaleFactor(float yScaleFactor) {
    this.scaleFactorY = yScaleFactor;
  ...
  public void setTopViewMarginRight(int topFragmentMarginRight) {
    this.marginRight = topFragmentMarginRight;
  ...
  public boolean onInterceptTouchEvent(MotionEvent ev) {
    try {
      if (!isEnabled() || isDisableDraggableView
              || (isViewHit(mMediaControllerView, (int) ev.getX(), (int) ev.getY())
              && isMaximized())) {
        return false;
      }
...
//      secondView.layout(left, transformer.getOriginalHeight(), right, bottom);
   ...
   * view height and to initialize DragViewCompat.
   */
  @Override
  ...
  void setBottomViewHeight(int height){
      findViewById(R.id.second_view).setMinimumHeight(height);
  }
  /**
  ...
  void changeSecondViewPosition() {
    //Log.d(TAG,"changeSecondViewPosition- " + dragView.getBottom());
  ...
  private void initializeViewDragHelper() {
    mDraggableViewCallback = new DraggableViewCallback(this, dragView);
    viewDragHelper = ViewDragHelper.create(this, SENSITIVITY, mDraggableViewCallback);
  }
  ...
  private void initializeTransformer() {
    ...
    transformer.setViewWidth(isFullScreen ? screenWidth : topViewWidth);
  ...
  /**
   * Realize a smooth slide to a slide offset passed as argument. This method is the base of
  ...
  public void setDisableDraggableViewOnTouch(boolean disableDraggableView) {
    isDisableDraggableView = disableDraggableView;
  }

  public void setDraggableViewCallbackListener(ViewDragHelper.Callback draggableCallbackListener) {
    if(mDraggableViewCallback != null){
      mDraggableViewCallback.setDraggableViewCallbackListener(draggableCallbackListener);
    }
  }

  public boolean isDraggedMinimumRange(){
    return transformer == null ? false : transformer.isDraggedMinimumRange();
  }
...
//      secondView.post(invalidateRunnable);
    }
  }
  ...
  private final Runnable invalidateRunnable = new Runnable() {
    @Override
    public void run() {
      LoggerD.debugLog("invalidateRunnable: all");
      DraggableView.this.requestFocus();
      DraggableView.this.invalidate();
      secondView.requestFocus();
      secondView.invalidate();
      dragView.requestLayout();
      dragView.invalidate();
      secondView.postDelayed(invalidateRunnable, 500);
    }
  };

  public void removeLayoutUpdates(){
    if(secondView != null){
      secondView.removeCallbacks(invalidateRunnable);
      secondView.post(null);
    }
  }

  public void setFullScreenParams() {
    dragView.getLayoutParams().width = ViewGroup.LayoutParams.MATCH_PARENT;
    dragView.getLayoutParams().height = ViewGroup.LayoutParams.MATCH_PARENT;
  }
  ...
  public void setTopViewWidth(int widthInPortraitMode) {
    topViewWidth = widthInPortraitMode;
  }
  ...
  public void slideToMiddle() {
    smoothSlideTo(DEFAULT_PLAYER_CLOSE_DRAG_OFFSET);
  }
