...
import com.google.android.exoplayer2.trackselection.InitializationTrackSelection;
...
/* package */ class HlsChunkSource {
  ...
  private final String prefPlayBackQuality;
...
*     multiple {@link HlsChunkSource}s are used for a single playback, they should all share the
   * @param prefPlayBackQuality
   */
  public HlsChunkSource(HlsPlaylistTracker playlistTracker, HlsUrl[] variants,
                        DataSource dataSource, TimestampAdjusterProvider timestampAdjusterProvider, String prefPlayBackQuality) {
    ...
    this.prefPlayBackQuality = prefPlayBackQuality;
    trackSelection = new InitializationTrackSelection(trackGroup, initialTrackSelection, prefPlayBackQuality);
  }
