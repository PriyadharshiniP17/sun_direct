...
public abstract class BaseTrackSelection implements TrackSelection {
  ...
  private int savedTrackPosition = -1;
  ...
  public void setSavedTrackPosition(int savedTrackPosition) {
    this.savedTrackPosition = savedTrackPosition;
  }


  public int getSavedTrackPosition() {
    return savedTrackPosition;
  }
