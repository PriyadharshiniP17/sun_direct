...
public class AutoScrollRecyclerView extends RecyclerView {
    ...
    private void notifyLayoutManager() {
        ...
        if (layoutManager instanceof CenterLayoutManager) {
            ...
            if (centerLayoutManager != null) {
                centerLayoutManager.setReverseLayout(mReverse);
            }
     ...
     */
    private static class NestingRecyclerViewAdapter<VH extends ViewHolder>
            extends Adapter<VH>
    {
         ...
         */
        public int generatePosition(int position) {
