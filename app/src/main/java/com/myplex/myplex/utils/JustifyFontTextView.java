...
public class JustifyFontTextView extends FontRegularTypeface {
        ...
        public JustifyFontTextView(Context context) {
            super(context);
        }

        public JustifyFontTextView(Context context, AttributeSet attrs) {
            super(context, attrs);
        }

        public JustifyFontTextView(Context context, AttributeSet attrs, int defStyle) {
