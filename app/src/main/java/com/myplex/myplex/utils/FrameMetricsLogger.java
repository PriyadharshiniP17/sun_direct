...
public class FrameMetricsLogger implements Application.ActivityLifecycleCallbacks {
            ...
            Window.OnFrameMetricsAvailableListener listener = new Window.OnFrameMetricsAvailableListener() {
                ...
                public void onFrameMetricsAvailable(Window window, FrameMetrics frameMetrics, int dropCountSinceLastInvocation) {
                    ...
                    if (totalDurationMs > warningLevelMs) {
                        ...
                        float swapBuffersDuration = (float) (0.000001 * frameMetricsCopy.getMetric(FrameMetrics.SWAP_BUFFERS_DURATION));
                        float inputHandlingDuration = (float) (0.000001 * frameMetricsCopy.getMetric(FrameMetrics.INPUT_HANDLING_DURATION));
                        float intendedVSync = (float) (0.000001 * frameMetricsCopy.getMetric(FrameMetrics.INTENDED_VSYNC_TIMESTAMP));
                        float VSyncTimeStamp = (float) (0.000001 * frameMetricsCopy.getMetric(FrameMetrics.VSYNC_TIMESTAMP));
                        ...
                        msg += String.format("Layout/measure: %.2fms, draw:%.2fms, gpuCommand:%.2fms,\n swapBufferDuration: %.2fms,inputHandlingDuration: %.2fms,intendedVSync: %.2fms,\n VSyncTimeStamp; %.2fms others:%.2fms\n",
                                layoutMeasureDurationMs, drawDurationMs, gpuCommandMs,swapBuffersDuration,inputHandlingDuration,intendedVSync,VSyncTimeStamp ,othersMs);
    ...
    public static class Builder {
        ...
        public FrameMetricsLogger build() {
            FrameMetricsLogger activityFrameMetrics = new FrameMetricsLogger();
