 ...
 */
public class LiveTVProgramItem  extends GenericListViewCompoment {
    ...
    AdapterLiveTvItem adapterLiveTvItem = null;
    GenericListViewCompoment holder = this;
    private Typeface mBoldTypeFace;
    public LiveTVProgramItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo, String menuGroup, String pageTitle) {
        super(view);
        this.view = view;
    ...
    public static LiveTVProgramItem createView(Context context, ViewGroup parent,
        ...
        return new LiveTVProgramItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo,menuGroup, pageTitle);
    }
...
//            }
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterLiveTvItem) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterLiveTvItem = (AdapterLiveTvItem) holder.mRecyclerViewCarousel.getTag();
            adapterLiveTvItem.setData(carouselInfoData.listCarouselData);
        } else {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " create adapter");
            adapterLiveTvItem = new AdapterLiveTvItem(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }
        LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " requestState- " + carouselInfoData.requestState);
        adapterLiveTvItem.showTitle(carouselInfoData.showTitle);
        ...
        holder.mRecyclerViewCarousel.setTag(adapterLiveTvItem);
        adapterLiveTvItem.setOnItemClickListenerWithMovieData(mOnItemClickListenerMovies);
        adapterLiveTvItem.setParentPosition(position);
        adapterLiveTvItem.setParentViewHolder(holder);
        adapterLiveTvItem.setCarouselInfoData(carouselInfoData.name, carouselInfoData.pageSize);
        adapterLiveTvItem.isContinueWatchingSection(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_CONTINUE_WATCHING.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterLiveTvItem.setRemoveItemListener(mOnItemRemovedListener);
        holder.mRecyclerViewCarousel.setAdapter(adapterLiveTvItem);
