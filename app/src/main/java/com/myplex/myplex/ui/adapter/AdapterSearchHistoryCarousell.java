...
public class AdapterSearchHistoryCarousell extends RecyclerView.Adapter<AdapterSearchHistoryCarousell.CarouselDataViewHolder>{

    private static final String TAG = AdapterSearchHistoryCarousell.class.getSimpleName();

    private final Context mContext;
    private ArrayList<String> mListMovies;
...
//                Util.updatePlayerStatus(0, Analytics.ACTION_TYPES.delete.name(), mListMovies.get(pos)._id,mListMovies.get(pos).generalInfo.type);
    ...
    public AdapterSearchHistoryCarousell(Context context, ArrayList<String> itemList, RecyclerView recyclerView) {
        mContext = context;
        mListMovies = itemList;
        recyclerViewReference = recyclerView;
        Log.e("Recent Search","Search"+itemList.size());
...
//    }
    ...
    public void setData(final ArrayList<String> listMovies) {
    ...
    public void addData(ArrayList<String> listMovies) {
        if (listMovies == null) {
            return;
        }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_search_item, parent, false);
    ...
    private void bindGenreViewHolder(final CarouselDataViewHolder holder, final String carouselData) {

//        new Handler().post(new Runnable() {
//            @Override
//            public void run() {

        holder.mTitle.setText(carouselData);
...
//            UiUtil.showFeedback(view, true, R.color.list_item_bkg);
            ...
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    String data = mListMovies.get(getAdapterPosition());
                    if (data == null) {
                        return false;
                    }
...
//        new MenuDataModel().fetchCarouseldataInAsynTask(mContext, mPageName, 1, mPageSize, true,this);
    ...
    private void addCarouselData(final ArrayList<String> carouselList) {
