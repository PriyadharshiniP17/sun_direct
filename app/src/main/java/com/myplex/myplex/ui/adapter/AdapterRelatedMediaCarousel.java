...
public class AdapterRelatedMediaCarousel extends RecyclerView.Adapter<AdapterRelatedMediaCarousel.CarouselDataViewHolder> {

    private static final String TAG = AdapterRelatedMediaCarousel.class.getSimpleName();
...
//    private boolean mIsDummyData = false;
    ...
    private List<CardDataRelatedMultimediaItem> mListMovies;
    //adapter view click listener

    public AdapterRelatedMediaCarousel(Context context, List<CardDataRelatedMultimediaItem> itemList) {
        mContext = context;
        mListMovies = itemList;
//        ScopedBus.getInstance().register(this);
    }
    public AdapterRelatedMediaCarousel(Context context, List<CardDataRelatedMultimediaItem> itemList, RecyclerView recyclerView) {
        mContext = context;
        mListMovies = itemList;
...
*/
    ...
    private void removeItem(View view) {
        ...
        try {
            if (view != null
                ...
                if (mListMovies.get(pos).generalInfo != null && mListMovies.get(pos).generalInfo.type != null) {
                    Util.updatePlayerStatus(0, Analytics.ACTION_TYPES.delete.name(), mListMovies.get(pos)._id, mListMovies.get(pos).generalInfo.type);
    ...
    public void setData(final List<CardDataRelatedMultimediaItem> listMovies) {
    ...
    public void addData(List<CardDataRelatedMultimediaItem> listMovies) {
        if (listMovies == null) {
            return;
        }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_carousel_grid_recycler, parent, false);
    ...
    private void bindGenreViewHolder(final CarouselDataViewHolder holder, final CardDataRelatedMultimediaItem carouselData) {
...
//        return type;
    ...
    public class CarouselDataViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private ItemClickListenerWithRelatedMediaData clickListener;
...
//
            ...
            view.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    CardDataRelatedMultimediaItem data = null;
        ...
        public void setClickListener(ItemClickListenerWithRelatedMediaData itemClickListener) {
    ...
    private ItemClickListenerWithRelatedMediaData mOnItemClickListenerWithData;

    public void setOnItemClickListenerWithMovieData(ItemClickListenerWithRelatedMediaData onItemClickListenerWithData) {
...
//        new MenuDataModel().fetchCarouseldataInAsynTask(mContext, mPageName, 1, mPageSize, true,this);
    ...
    private void addCarouselData(final List<CardDataRelatedMultimediaItem> carouselList) {
...
//            notifyItemChanged(position);
    ...
    public final ItemClickListenerWithRelatedMediaData mOnItemClickListenerDefault = new ItemClickListenerWithRelatedMediaData() {
        @Override
        public void onClick(View view, int position, int parentPosition, final CardDataRelatedMultimediaItem carouselData) {
...
*/
    ...
    public final String getImageLink(CardDataRelatedMultimediaItem carouselData) {
    ...
    public void showViewRatingOnThumbnail(AdapterRelatedMediaCarousel.CarouselDataViewHolder holder, CardData cardData){
