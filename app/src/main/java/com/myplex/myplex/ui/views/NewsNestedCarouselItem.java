...
import com.myplex.myplex.ui.adapter.AdapterNewsNestedCarousel;
...
public class NewsNestedCarouselItem extends GenericListViewCompoment {
    ...
    AdapterNewsNestedCarousel adapterNewsNestedCarousel = null;
    String mBgColor;
    private Typeface mBoldTypeFace;
    public NewsNestedCarouselItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo
    ...
    public static NewsNestedCarouselItem createView(Context context, ViewGroup parent,
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.listitem_carousel_recyclerview_grid, parent, false);
        return new NewsNestedCarouselItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup,  mPageTitle,mBgColor);
    }
    ...
    public void bindItemViewHolder(int position) {
        ...
        adapterNewsNestedCarousel = null;
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterNewsNestedCarousel) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterNewsNestedCarousel = (AdapterNewsNestedCarousel) holder.mRecyclerViewCarousel.getTag();
            adapterNewsNestedCarousel.setData(carouselInfoData.listCarouselData);
        } else {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " create adapter");
            adapterNewsNestedCarousel = new AdapterNewsNestedCarousel(mContext, carouselInfoData.listCarouselData, holder.mRecyclerViewCarousel);
        }
        if (carouselInfoData != null)
            adapterNewsNestedCarousel.showTitle(carouselInfoData.showTitle);
        ...
        WrapperLinearLayoutManager linearLayoutManager=new WrapperLinearLayoutManager(mContext,LinearLayoutManager.HORIZONTAL,false);
        //CustomGridLayoutManager linearLayoutManager = new CustomGridLayoutManager(mContext,2);
        ...
        /*GridSpacingItemDecoration mHorizontalMoviesDivieder = new GridSpacingItemDecoration(2,(int) mContext
                .getResources().getDimension(R.dimen.margin_gap_0),true);
        *//*linearLayoutManager.setItemPrefetchEnabled(false);*/
        ...
        holder.mRecyclerViewCarousel.setTag(adapterNewsNestedCarousel);
        adapterNewsNestedCarousel.setOnItemClickListenerWithMovieData(mOnItemClickListenerMovies);
        adapterNewsNestedCarousel.setParentPosition(position);
        adapterNewsNestedCarousel.setParentViewHolder(holder);
        adapterNewsNestedCarousel.setBgColor(mBgColor);
        adapterNewsNestedCarousel.setCarouselInfoData(carouselInfoData.name, carouselInfoData.pageSize);
        adapterNewsNestedCarousel.isContinueWatchingSection(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_CONTINUE_WATCHING.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterNewsNestedCarousel.setRemoveItemListener(mOnItemRemovedListener);
        holder.mRecyclerViewCarousel.setAdapter(adapterNewsNestedCarousel);
