...
public class LiveSquareHorizontalItem extends GenericListViewCompoment {
    ...
    AdapterSquareHorizontalCarousel adapterSmallHorizontalCarousel = null;
    String mBgColor;
    private boolean isFromSearch;
    private Typeface mBoldTypeFace;
    public LiveSquareHorizontalItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo
        ...
        int margin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 7, mContext.getResources().getDisplayMetrics());
    ...
    public static LiveSquareHorizontalItem createView(Context context, ViewGroup parent,
        ...
        return new LiveSquareHorizontalItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup,  mPageTitle,mBgColor, isFromSearch);
    }
    ...
    public void bindItemViewHolder(int position) {
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterSmallHorizontalCarousel) {
            ...
            adapterSmallHorizontalCarousel = (AdapterSquareHorizontalCarousel) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterSmallHorizontalCarousel = new AdapterSquareHorizontalCarousel(mContext, carouselInfoData.listCarouselData, holder.mRecyclerViewCarousel);
        }
        if (carouselInfoData != null)
