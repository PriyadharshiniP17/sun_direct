...
public class AdapterBigHorizontalCarousel extends RecyclerView.Adapter<AdapterBigHorizontalCarousel.CarouselDataViewHolder>{
...
//    private boolean mIsDummyData = false;
    ...
    private String layoutType, isFromApp;
    ...
    public AdapterBigHorizontalCarousel(Context context, List<CardData> itemList, RecyclerView recyclerView,String mPageName) {
        mContext = context;
    ...
    public AdapterBigHorizontalCarousel(Context context, List<CardData> itemList, RecyclerView recyclerView,String mPageName, String isFromApp) {
        mContext = context;
        mListMovies = itemList;
        mListMoviesRef = itemList;
        this.mPageName=mPageName;
    ...
    public AdapterBigHorizontalCarousel(Context context, List<CardData> itemList) {
        mContext = context;
        mListMovies = itemList;
    }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType==TYPE_ITEM){
            view = LayoutInflater.from(mContext).inflate(R.layout.listitem_movie_recycler, parent, false);
        }else {
...
//        });
        ...
        if (!TextUtils.isEmpty(partnerImageLink)) {
           /* if(isFromApp != null && isFromApp.equalsIgnoreCase("true")) {
                holder.mImageViewPartner.setVisibility(GONE);
            }
            else{*/
            ...
            if(holder.mImageViewPartner.getLayoutParams().height > 0){
...
//            mImageViewRupeeIcon = (ImageView)view.findViewById(R.id.thumbnail_rupee_icon);
            ...
            */
            ...
            fixedLayout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.big_horizontal_width);
            mImageViewMovies.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.big_horizontal_width);
