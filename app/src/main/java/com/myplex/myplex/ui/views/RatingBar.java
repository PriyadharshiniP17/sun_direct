...
public class RatingBar extends FrameLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mFillDrawable = context.getDrawable(R.mipmap.star_selected);
                mEmptyDrawable = context.getDrawable(R.mipmap.star_unselected);
            } else {
                mFillDrawable = context.getResources().getDrawable(R.mipmap.star_selected);
                mEmptyDrawable = context.getResources().getDrawable(R.mipmap.star_unselected);
            }
        } else {
