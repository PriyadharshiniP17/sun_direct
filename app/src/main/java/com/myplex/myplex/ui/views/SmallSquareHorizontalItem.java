...
import com.myplex.myplex.ui.adapter.AdapterSquareHorizontalCarousel;
 ...
 */
public class SmallSquareHorizontalItem extends GenericListViewCompoment {
    ...
    AdapterSquareHorizontalCarousel adapterSquareHorizontalCarousel = null;
    private  boolean isFromSearch;
    private Typeface mBoldTypeFace;
    public SmallSquareHorizontalItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo, boolean isFromSearch) {
        super(view);
        this.view = view;
    ...
    public static SmallSquareHorizontalItem createView(Context context, ViewGroup parent,
                                               List<CarouselInfoData> carouselInfoData, RecyclerView mRecyclerViewCarouselInfo, boolean isFromSearch) {
        View view = LayoutInflater.from(context).inflate(R.layout.listitem_carousel_linear_recycler, parent, false);
        return new SmallSquareHorizontalItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, isFromSearch);
    }
...
//            }
        ...
        adapterSquareHorizontalCarousel = null;
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterSquareHorizontalCarousel) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterSquareHorizontalCarousel = (AdapterSquareHorizontalCarousel) holder.mRecyclerViewCarousel.getTag();
            adapterSquareHorizontalCarousel.setData(carouselInfoData.listCarouselData);
        } else {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " create adapter");
            adapterSquareHorizontalCarousel = new AdapterSquareHorizontalCarousel(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }
        if (carouselInfoData != null)
            adapterSquareHorizontalCarousel.showTitle(carouselInfoData.showTitle);
        ...
        holder.mRecyclerViewCarousel.setTag(adapterSquareHorizontalCarousel);
        adapterSquareHorizontalCarousel.setOnItemClickListenerWithMovieData(mOnItemClickListenerMovies);
        adapterSquareHorizontalCarousel.setParentPosition(position);
        adapterSquareHorizontalCarousel.setParentViewHolder(holder);
        adapterSquareHorizontalCarousel.setCarouselInfoData(carouselInfoData.name, carouselInfoData.pageSize);
        adapterSquareHorizontalCarousel.isContinueWatchingSection(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_CONTINUE_WATCHING.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterSquareHorizontalCarousel.setRemoveItemListener(mOnItemRemovedListener);
        holder.mRecyclerViewCarousel.setAdapter(adapterSquareHorizontalCarousel);
        ...
        public void onClick(final View view) {
            ...
            if (view.getTag() instanceof CarouselInfoData) {
                ...
                if (APIConstants.LAYOUT_TYPE_BROWSE_LIST.equalsIgnoreCase(carouselData.showAllLayoutType)) {
                    ...
                    return;
                } else if (carouselData != null && carouselData.showAllLayoutType!=null
