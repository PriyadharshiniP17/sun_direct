...
public class VmaxImageAdItem extends GenericListViewCompoment {
    ...
    public VmaxImageAdItem(Context mContext,View view,RecyclerView mRecyclerViewCarouselInfo,CarouselInfoData carouselInfoData) {
        super(view);
    ...
    public static VmaxImageAdItem createView(Context context,CarouselInfoData carouselInfoData, RecyclerView mRecyclerViewCarouselInfo){


        return new VmaxImageAdItem(context,getVmaxAdView(context,carouselInfoData),mRecyclerViewCarouselInfo,carouselInfoData);
    }
    ...
    public static View getVmaxAdView(Context mContext,CarouselInfoData carouselInfoData) {
        ...
        adId = PrefUtils.getInstance().getPrefVmaxNativeDisplayAdId();
        if (carouselInfoData != null && !TextUtils.isEmpty(carouselInfoData.title)) {
            ...
            adId = PropertiesHandler.getPropertiesNativeDisplayAdSpotIdMap().get(carouselInfoData.title);
