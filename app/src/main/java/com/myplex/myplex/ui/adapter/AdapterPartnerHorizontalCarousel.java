...
public class AdapterPartnerHorizontalCarousel extends RecyclerView.Adapter<AdapterPartnerHorizontalCarousel.CarouselDataViewHolder>{

    private static final String TAG = AdapterPartnerHorizontalCarousel.class.getSimpleName();
    ...
    public AdapterPartnerHorizontalCarousel(Context context, List<CardData> itemList, RecyclerView recyclerView, boolean isFromSearch) {
        mContext = context;
...
//    }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_partner_horizontal_item, parent, false);
...
//                Picasso.with(mContext).load(APIConstants.getErosNowMusicLogoUrl()).into(holder.mImageViewProvideLogo);
            ...
            if(!isFromSearch)
                ...
                imageLink = getImageLink(carouselData, holder.mImageViewMovies);
...
//        return type;
    ...
    class CarouselDataViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private RelativeLayout viewRatingParentLayout, parent_ll;
        private FixedAspectRatioRelativeLayout fixedLayout;
...
//            mImageViewRupeeIcon = (ImageView)view.findViewById(R.id.thumbnail_rupee_icon);
            ...
            fixedLayout = view.findViewById(R.id.fixed_layout);
            parent_ll = view.findViewById(R.id.parent_ll);
            view.setOnClickListener(this);
            view.setLongClickable(true);
            fixedLayout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.partner_image_width);
            mImageViewMovies.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.partner_image_width);
            parent_ll.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.partner_image_width);
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public final String getImageLink(CardData carouselData) {
        ...
        String[] imageTypes = new String[]{APIConstants.IMAGE_TYPE_SQUARE_BANNER,APIConstants.IMAGE_TYPE_THUMBNAIL,APIConstants.IMAGE_TYPE_SQUARE};
    ...
    private String getImageLink(CardData mData, ImageView imageView) {
        ...
        if (mData == null || mData.images == null || mData.images.values == null) {
            return null;
        }
