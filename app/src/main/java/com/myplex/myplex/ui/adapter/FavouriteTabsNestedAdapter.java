...
public class FavouriteTabsNestedAdapter extends FragmentStatePagerAdapter {
    ...
    public FavouriteTabsNestedAdapter(@NonNull FragmentManager fragment, TabLayout tabLayout, boolean isFavourite) {
   ...
   /* public TabsNestedAdapter(FragmentManager fm) {
    ...
    public Fragment getItem(int position) {
        Fragment mFragment;
        //if(!isFavourite)
        mFragment = FavouriteNewFragment.newInstance(tabLayout.getTabAt(position).getText().toString());
