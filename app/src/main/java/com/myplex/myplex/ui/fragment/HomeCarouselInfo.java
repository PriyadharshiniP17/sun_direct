 ...
 */
public class HomeCarouselInfo extends BaseFragment implements AdapterCarouselInfo.CallbackListener {
    public static final String PARAM_APP_FRAG_TYPE = "fragment_type";
    private static final String TAG = HomeCarouselInfo.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.home_carouselinfo, container, false);
        ScopedBus.getInstance().register(this);
...
//        initAdView();
        ...
        int height = ApplicationController.getApplicationConfig().screenHeight - ((int) mContext.getResources().getDimension(R.dimen._54sdp)+(int) mContext.getResources().getDimension(R.dimen.margin_gap_64)+(int) mContext.getResources().getDimension(R.dimen._60sdp));
        int width = displayMetrics.widthPixels;

        // int newHeight =Math.round( (height - (int)getResources().getDimension(R.dimen._100sdp)));
        ...
        browse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ((MainActivity) getActivity()).hideToolbar();
                        scrollLayout.smoothScrollBy(0, (height - scrollLayout.getScrollY()) + browse.getHeight() + (int) mContext.getResources().getDimension(R.dimen.margin_gap_20), 300);
                    }
                }, 200);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            scrollLayout.setOnScrollChangeListener(new View.OnScrollChangeListener() {
                ...
                public void onScrollChange(View view, int i, int i1, int i2, int i3) {
                    ...
                    view = scrollLayout.getChildAt(scrollLayout.getChildCount() - 1);
                    int topDetector = scrollLayout.getScrollY();
                    int bottomDetector = view.getBottom() - (scrollLayout.getHeight() + scrollLayout.getScrollY());
                  /*  if(bottomDetector == 0 ){
                        ((MainActivity)getActivity()).hideToolbar();

                    }
                    if(bottomDetector>0 && topDetector>0){
                        ((MainActivity)getActivity()).hideToolbar();
                    }*/
                    if (topDetector <= 0) {
                        ((MainActivity) getActivity()).showToolbar();
                        ((MainActivity) getActivity()).setToolBarCollapsible(true, false);
    ...
    public static HomeCarouselInfo newInstance(Bundle args) {
        HomeCarouselInfo fragmentCarouselInfo = new HomeCarouselInfo();
       ...
       /* int density = getResources().getDisplayMetrics().densityDpi;
        switch (density) {
            ...
            case DisplayMetrics.DENSITY_XHIGH:
                ...
                nestedTabsLayout.setTabMode(TabLayout.MODE_FIXED);
                break;
            default:
                //   Toast.makeText(this, " " + density, Toast.LENGTH_SHORT).show();
                nestedTabsLayout.setTabMode(TabLayout.MODE_FIXED);
        ...
        for (int i = 0; i < mListCarouselInfo.size(); i++) {
            ...
            tabText.setText(mListCarouselInfo.get(i).title);
            if (i == 0) {
                tabText.setBackground(mContext.getResources().getDrawable(R.drawable.rounded_btn_yellow));
                tabText.setTextColor(mContext.getResources().getColor(R.color.black));
            }
     ...
     /*   new TabLayoutMediator(nestedTabsLayout, viewPager2,
                new TabLayoutMediator.TabConfigurationStrategy() {
                    @Override public void onConfigureTab(@NonNull TabLayout.Tab tab, int position) {
                        ...
                        ((TextView) tab.getCustomView().findViewById(R.id.tabText)).setBackgroundColor(mContext.getResources().getColor(R.color.yellow));
                    }
                }
        ).attach();*/
        nestedTabsLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (tab != null && tab.getTag() != null) {
                    ...
                    ((TextView) tab.getCustomView().findViewById(R.id.tabText)).setBackground(mContext.getResources().getDrawable(R.drawable.rounded_btn_yellow));
                    ((TextView) tab.getCustomView().findViewById(R.id.tabText)).setTextColor(mContext.getResources().getColor(R.color.black));
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                if (tab != null && tab.getTag() != null) {
                    ((TextView) tab.getCustomView().findViewById(R.id.tabText)).setBackgroundColor(mContext.getResources().getColor(R.color.transparent));
                    ((TextView) tab.getCustomView().findViewById(R.id.tabText)).setTextColor(mContext.getResources().getColor(R.color.white));
                }
            }
        ...
        viewPager2.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                if (isVisible() && mListCarouselInfo != null && !mListCarouselInfo.isEmpty()) {
                    ...
                    //nestedTabsLayout.setScrollPosition(position,0f,true);
                    nestedTabsLayout.getTabAt(position).select();
                }
            }
