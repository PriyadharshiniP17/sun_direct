...
public class StickHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void setListener(StickyHeaderInterface mListener) {
    ...
    private View getHeaderViewForItem(int headerPosition, RecyclerView parent) {
        View header = mListener.getHeaderLayout(headerPosition, parent);
    ...
    public interface StickyHeaderInterface {
         ...
         */
        View getHeaderLayout(int headerPosition, RecyclerView parent);
