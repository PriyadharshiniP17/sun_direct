...
import com.myplex.myplex.ui.adapter.AdapterBannerNewHorizontalCarousel;
 ...
 */
public class BannerNewHorizontalItem extends GenericListViewCompoment{
    ...
    AdapterBannerNewHorizontalCarousel adapterLargeHorizontalCarousel = null;
    private Typeface mBoldTypeFace;

    public BannerNewHorizontalItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo, String mMenuGroup, String mPageTitle) {
        super(view);
        this.view = view;
        ...
        int margin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, mContext.getResources().getDisplayMetrics());
    ...
    public static BannerNewHorizontalItem createView(Context context, ViewGroup parent,
                                                     List<CarouselInfoData> carouselInfoData, RecyclerView mRecyclerViewCarouselInfo, String mMenuGroup, String mPageTitle) {
        View view = LayoutInflater.from(context).inflate(R.layout.listitem_carousel_linear_recycler_carousel_banner, parent, false);
        return new BannerNewHorizontalItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup, mPageTitle);
    }
...
//            }
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterBannerNewHorizontalCarousel) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterLargeHorizontalCarousel = (AdapterBannerNewHorizontalCarousel) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterLargeHorizontalCarousel = new AdapterBannerNewHorizontalCarousel(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }
        ...
        holder.mRecyclerViewCarousel.addItemDecoration(new RecyclerView.ItemDecoration() {
            @Override
