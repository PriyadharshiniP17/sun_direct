...
import com.myplex.myplex.ui.adapter.ViewPagerAnimationBigHorizontalAdapter;
...
public class AnimationViewPagerItemBigHorizontal extends GenericListViewCompoment {

    private List<CarouselInfoData> mListCarouselInfo;
    private Context mContext;
    private static final String TAG = AnimationViewPagerItemBigHorizontal.class.getSimpleName();
    ...
    ViewPagerAnimationBigHorizontalAdapter imageSliderAdapter = null;
    String mBgColor;
    private Typeface mBoldTypeFace;
    private AnimationViewPagerItemBigHorizontal(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo,
    ...
    public static AnimationViewPagerItemBigHorizontal createView(Context context, ViewGroup parent,
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.layout_anim_big_horizontal_recyclerview, parent, false);

        return new AnimationViewPagerItemBigHorizontal(context, view,
    ...
    public void bindItemViewHolder(final int position) {
        ...
        if (carouselInfoData.listCarouselData == null || carouselInfoData.listCarouselData.isEmpty()) {
            holder.mListPlayerRecyclerCarousel.setVisibility(View.GONE);
            ...
            if(carouselInfoData.showTitle){
                holder.mLayoutCarouselTitle.setVisibility(View.VISIBLE);
            }else {
            ...
            if (holder.mListPlayerRecyclerCarousel.getTag() != null
                    && holder.mListPlayerRecyclerCarousel.getTag() instanceof ViewPagerAnimationBigHorizontalAdapter) {
                imageSliderAdapter = (ViewPagerAnimationBigHorizontalAdapter) holder.mListPlayerRecyclerCarousel.getTag();
            } else {
                imageSliderAdapter = new ViewPagerAnimationBigHorizontalAdapter(mContext);
                imageSliderAdapter.setItems(carouselInfoData.listCarouselData);
            }
            holder.mListPlayerRecyclerCarousel.setTag(imageSliderAdapter);

            imageSliderAdapter.setOnItemClickListener(new ViewPagerAnimationBigHorizontalAdapter.OnItemClickListener() {
                @Override
            ...
            holder.mListPlayerRecyclerCarousel.setAdapter(imageSliderAdapter);
            ...
            holder.mListPlayerRecyclerCarousel.setVisibility(View.VISIBLE);


            /*if (carouselInfoData.listCarouselData != null
                    && carouselInfoData.listCarouselData.size() > 1) {
                holder.mListPlayerRecyclerCarousel.setOffscreenPageLimit(3);
            }*/
