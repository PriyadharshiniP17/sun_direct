...
import com.myplex.myplex.ui.adapter.AdapterBigBannerHorizontalCarousel;
...
public class BigBannerHorizontalCarousel extends GenericListViewCompoment {
    ...
    AdapterBigBannerHorizontalCarousel adapterBigBannerHorizontalCarousel = null;
    String mBgColor;
    private Typeface mBoldTypeFace;
    public BigBannerHorizontalCarousel(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo,
    ...
    public static BigBannerHorizontalCarousel createView(Context context, ViewGroup parent,
        ...
        return new BigBannerHorizontalCarousel(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup, mPageTitle,mBgColor);
    }
...
//            }
        ...
        adapterBigBannerHorizontalCarousel = null;
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterBigBannerHorizontalCarousel) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterBigBannerHorizontalCarousel = (AdapterBigBannerHorizontalCarousel) holder.mRecyclerViewCarousel.getTag();
            adapterBigBannerHorizontalCarousel.setData(carouselInfoData.listCarouselData);
        } else {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " create adapter");
            adapterBigBannerHorizontalCarousel = new AdapterBigBannerHorizontalCarousel(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }
        LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " requestState- " + carouselInfoData.requestState);
        adapterBigBannerHorizontalCarousel.showTitle(carouselInfoData.showTitle);
        ...
        holder.mRecyclerViewCarousel.setTag(adapterBigBannerHorizontalCarousel);
        adapterBigBannerHorizontalCarousel.setOnItemClickListenerWithMovieData(mOnItemClickListenerMovies);
        adapterBigBannerHorizontalCarousel.setParentViewHolder(holder);
        adapterBigBannerHorizontalCarousel.setParentPosition(position);
        adapterBigBannerHorizontalCarousel.setCarouselInfoData(carouselInfoData.name, carouselInfoData.pageSize);
        adapterBigBannerHorizontalCarousel.isContinueWatchingSection(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_CONTINUE_WATCHING.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterBigBannerHorizontalCarousel.isGenericLayout(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_HORIZONTAL_LIST_GENERIC_ITEM.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterBigBannerHorizontalCarousel.setRemoveItemListener(mOnItemRemovedListener);
        holder.mRecyclerViewCarousel.setAdapter(adapterBigBannerHorizontalCarousel);
    ...
    private class CarouselRequestTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            new MenuDataModel().fetchCarouseldata(mContext, carouselInfoData.name, 1, carouselInfoData.pageSize > 0 ? carouselInfoData.pageSize : APIConstants.PAGE_INDEX_COUNT, isCacheRequest, carouselInfoData.modified_on,new MenuDataModel.CarouselContentListCallback() {
                @Override
