 ...
 */
public class MediumHorizontalItem extends GenericListViewCompoment {
    ...
    AdapterMedHorizontalCarousel adapterMedHorizontalCarousel = null;
    String mBgcolor;
    private  boolean isFromSearch;
    private Typeface mBoldTypeFace;

    public MediumHorizontalItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo,
...
//        int margin = (int) mContext.getResources().getDimension(R.dimen.thumbnail_gap);
    ...
    public static MediumHorizontalItem createView(Context context, ViewGroup parent,
        ...
        return new MediumHorizontalItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup, mPageTitle,mBgcolor, isFromSearch);
    }
...
//            }
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterMedHorizontalCarousel) {
            ...
            adapterMedHorizontalCarousel = (AdapterMedHorizontalCarousel) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterMedHorizontalCarousel = new AdapterMedHorizontalCarousel(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }
