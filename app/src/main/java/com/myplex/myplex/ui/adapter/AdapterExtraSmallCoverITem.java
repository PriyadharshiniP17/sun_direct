...
public class AdapterExtraSmallCoverITem extends RecyclerView.Adapter<AdapterExtraSmallCoverITem.CarouselDataViewHolder> {

    private static final String TAG = AdapterExtraSmallCoverITem.class.getSimpleName();
...
//    private boolean mIsDummyData = false;
    ...
    public AdapterExtraSmallCoverITem(Context context, List<CardData> itemList) {
        mContext = context;
        mListMovies = itemList;
//        ScopedBus.getInstance().register(this);
    }
    public AdapterExtraSmallCoverITem(Context context, List<CardData> itemList, RecyclerView recyclerView) {
        mContext = context;
        mListMovies = itemList;
...
*/
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_extra_small_cover, parent, false);
...
//                    Picasso.with(mContext).load(APIConstants.getErosNowMusicLogoUrl()).into(holder.mImageViewProvideLogo);
                ...
                if(carouselData!=null && carouselData.content!=null && carouselData.content.channelNumber!=null){
...
//            mImageViewRupeeIcon = (ImageView)view.findViewById(R.id.thumbnail_rupee_icon);
            ...
            fixedAspectRatioRelativeLayout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.extra_small_horizontal_width);
            mImageViewMovies.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.extra_small_horizontal_width);
//
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public void showViewRatingOnThumbnail(AdapterExtraSmallCoverITem.CarouselDataViewHolder holder, CardData cardData){
