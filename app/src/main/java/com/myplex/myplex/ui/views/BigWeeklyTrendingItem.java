...
import com.myplex.myplex.ui.adapter.AdapterBigWeeklyTrending;
 ...
 */
public class BigWeeklyTrendingItem extends GenericListViewCompoment {
    ...
    AdapterBigWeeklyTrending adapterMedHorizontalCarousel = null;
    String mBgcolor;
    private  boolean isFromSearch;
    private Typeface mBoldTypeFace;
    public BigWeeklyTrendingItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo,
                                 RecyclerView mRecyclerViewCarouselInfo, String mMenuGroup, String mPageTitle, String mBgcolor, boolean isFromSearch) {
        super(view);
        this.view = view;
      ...
      //  int margin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (int)mContext.getResources().getDimension(R.dimen.thumbnail_gap), mContext.getResources().getDisplayMetrics());
    ...
    public static BigWeeklyTrendingItem createView(Context context, ViewGroup parent,
                                                   List<CarouselInfoData> carouselInfoData, RecyclerView mRecyclerViewCarouselInfo, String mMenuGroup,
                                                   String mPageTitle, String mBgcolor, boolean isFromSearch) {
        View view = LayoutInflater.from(context).inflate(R.layout.listitem_carousel_linear_recycler, parent, false);
        return new BigWeeklyTrendingItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup, mPageTitle,mBgcolor, isFromSearch);
    }
    ...
    public void bindItemViewHolder(int position) {
       ...
       // holder.mImageViewAll.setVisibility(View.GONE);
        ...
        if((carouselInfoData!=null && carouselInfoData.title!=null && carouselInfoData.title.equalsIgnoreCase("true")))
        {
...
//            }
        ...
        adapterMedHorizontalCarousel = null;
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterBigWeeklyTrending) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterMedHorizontalCarousel = (AdapterBigWeeklyTrending) holder.mRecyclerViewCarousel.getTag();
            adapterMedHorizontalCarousel.setData(carouselInfoData.listCarouselData);
        } else {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " create adapter");
            adapterMedHorizontalCarousel = new AdapterBigWeeklyTrending(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }

        LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " requestState- " + carouselInfoData.requestState);
        adapterMedHorizontalCarousel.showTitle(carouselInfoData.showTitle);
        ...
        adapterMedHorizontalCarousel.setParentViewHolder(holder);
        adapterMedHorizontalCarousel.setParentPosition(position);
        adapterMedHorizontalCarousel.setBgColor(mBgcolor);
        adapterMedHorizontalCarousel.setCarouselInfoData(carouselInfoData.name, carouselInfoData.pageSize);
        adapterMedHorizontalCarousel.isContinueWatchingSection(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_CONTINUE_WATCHING.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterMedHorizontalCarousel.isGenericLayout(carouselInfoData.layoutType != null
