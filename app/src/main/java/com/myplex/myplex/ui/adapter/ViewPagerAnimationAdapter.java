...
public class ViewPagerAnimationAdapter extends RecyclerView.Adapter<ViewPagerAnimationAdapter.ViewHolder> {
    ...
    public ViewPagerAnimationAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder mViewHolder, int position) {
        ...
        params.setMargins(0, -devicewidth/4, 0, -devicewidth/4);
