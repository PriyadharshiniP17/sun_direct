...
public class AdapterSeasonItemCarousel extends RecyclerView.Adapter<AdapterSeasonItemCarousel.CarouselDataViewHolder> {

    private static final String TAG = AdapterSeasonItemCarousel.class.getSimpleName();
...
//    private boolean mIsDummyData = false;
    ...
    public AdapterSeasonItemCarousel(Context context, List<CardData> itemList) {
        mContext = context;
        mListMovies = itemList;
//        ScopedBus.getInstance().register(this);
    }
    public AdapterSeasonItemCarousel(Context context, List<CardData> itemList, RecyclerView recyclerView) {
        mContext = context;
        mListMovies = itemList;
...
*/
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.season_listitem_carousel, parent, false);
...
//                        S2 | E1 | Pal Pal Dil Ke Paas
        ...
        if (!TextUtils.isEmpty(carouselData.getTitle())) {
            holder.mTextViewVODInfo1.setVisibility(View.VISIBLE);
            holder.mTextViewVODInfo1.setText(carouselData.getTitle());
            if(!isContinueWatchingSection && carouselData.generalInfo!=null && carouselData.generalInfo._id!=null && contentId.equalsIgnoreCase(carouselData.generalInfo._id)){
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public void showViewRatingOnThumbnail(AdapterSeasonItemCarousel.CarouselDataViewHolder holder, CardData cardData){
