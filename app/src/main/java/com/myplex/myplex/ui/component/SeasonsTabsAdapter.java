...
public class SeasonsTabsAdapter extends FragmentStatePagerAdapter {
    ...
    public SeasonsTabsAdapter(FragmentManager fragmentManager,
    ...
    public Fragment getItem(int position) {
        SeasonTabFragment episodeTabFragment=new SeasonTabFragment().newInstance(mListener,position,mValues,
                mListCarouselInfoData,mTVShowCardData,tabNames.get(position),mBgColor,fragmentManager);
