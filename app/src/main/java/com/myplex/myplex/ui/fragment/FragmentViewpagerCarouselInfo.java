 ...
 */
public class FragmentViewpagerCarouselInfo extends BaseFragment implements AdapterCarouselInfo.CallbackListener {
    public static final String PARAM_APP_FRAG_TYPE = "fragment_type";
    private static final String TAG = FragmentViewpagerCarouselInfo.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fab_top_scroll =  getParentFragment().getView().findViewById(R.id.fab_top_scroll);
...
//        initAdView();
        mAdapterCarouselInfo = new AdapterCarouselInfo(mContext, loadDummyInfo(),"false");
      ...
      /*  int margin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 24, mContext.getResources().getDisplayMetrics());
       ...
       /* RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) rootView.findViewById(R.id.fab_top_scroll).getLayoutParams();
        layoutParams.setMargins(0, 0, 250, 350);
        fab_top_scroll.setLayoutParams(layoutParams);
        ...
        mSwipeToRefreshHome.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                ((MainActivity)requireActivity()).updateBottomBar(true, 0);
                ((MainActivity)requireActivity()).blurlayout_toolbar.setVisibility(GONE);
                mAdapterCarouselInfo.setCallBackListener(FragmentViewpagerCarouselInfo.this);
                mRecyclerViewCarouselInfo.setAdapter(mAdapterCarouselInfo);
                loadCarouselInfo();
            }
        });
    ...
    public static FragmentViewpagerCarouselInfo newInstance(Bundle args) {
        FragmentViewpagerCarouselInfo fragmentCarouselInfo = new FragmentViewpagerCarouselInfo();
