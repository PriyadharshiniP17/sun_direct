...
public class ViewPagerImageSliderAdapter extends RecyclingPagerAdapter {
     ...
     */
    public ViewPagerImageSliderAdapter setInfiniteLoop(boolean isInfiniteLoop) {
...
*/
    ...
    public View getView(int position, View convertView, ViewGroup collection) {
        ...
        convertView = mInflater.inflate(R.layout.view_ottapp_slider, collection, false);
    ...
    if(!sliderModel.generalInfo.isSellable){
            ...
            if( mViewHolder.iv_partner!=null) {
