...
import com.myplex.myplex.ui.adapter.AdapterRoundedArtistHorizontalCarousel;
...
public class RoundedArtistHorizontalItem extends GenericListViewCompoment {
    ...
    AdapterRoundedArtistHorizontalCarousel adapterRoundedArtistHorizontalCarousel = null;
    private Typeface mBoldTypeFace;
    public RoundedArtistHorizontalItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo,String mMenuGroup, String mPageTitle) {
        super(view);
        this.view = view;
    ...
    public static RoundedArtistHorizontalItem createView(Context context, ViewGroup parent,
        ...
        return new RoundedArtistHorizontalItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup, mPageTitle);
    }
...
//            }
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterMedHorizontalCarousel) {
            ...
            adapterRoundedArtistHorizontalCarousel = (AdapterRoundedArtistHorizontalCarousel) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterRoundedArtistHorizontalCarousel = new AdapterRoundedArtistHorizontalCarousel(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }
