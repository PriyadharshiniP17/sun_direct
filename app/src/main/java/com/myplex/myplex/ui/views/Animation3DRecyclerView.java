...
public class Animation3DRecyclerView extends AutoScrollRecyclerView {

    public Animation3DRecyclerView(@NonNull Context context) {
        super(context);
        this.mContext = context;
        initialize(mContext);
    }

    public Animation3DRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initialize(mContext);
    }

    public Animation3DRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private RecyclerAnimationAdapter.ViewHolder mPlayerItemViewHolder;
                ...
                if (isAttachedToWindow()) {
                    if(playPosition+1 < MAX_POSITIONS_TO_SCROLL){
                        ...
                        if( layoutManager!= null)
                            layoutManager.smoothScrollToPosition(Animation3DRecyclerView.this,null,playPosition);
                    }
                }
    ...
    private void preparePlayerWithUrl() {
        ...
        initialize(mContext);
        try {
            mPlayerItemViewHolder  = (RecyclerAnimationAdapter.ViewHolder) findViewHolderForAdapterPosition(playPosition);
