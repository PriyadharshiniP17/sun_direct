...
public class AdapterSmallHorizontalCarousel extends RecyclerView.Adapter<AdapterSmallHorizontalCarousel.CarouselDataViewHolder> {
...
//    private boolean mIsDummyData = false;
    ...
    public AdapterSmallHorizontalCarousel(Context context, List<CardData> itemList) {
        mContext = context;
...
//        ScopedBus.getInstance().register(this);
    ...
    public AdapterSmallHorizontalCarousel(Context context, List<CardData> itemList,RecyclerView recyclerView) {
        mContext = context;
        mListMovies = itemList;
...
*/
    ...
    private final View.OnClickListener mOnItemRemoveClickListener = new View.OnClickListener() {
        @Override
...
//            public void run() {
        ...
        if (carouselData != null) {
           ...
           // holder.mChannelNumber.setVisibility(View.VISIBLE);
            holder.mTextViewMovieTitle.setVisibility(View.GONE);
            holder.mChannelNumber.setVisibility(View.GONE);
...
//                    holder.mTextViewMovieTitle.setText(carouselData.globalServiceName);
                ...
                holder.mTextViewMovieTitle.setTypeface(mBoldTypeFace);
                if(carouselData!=null && carouselData.content!=null && carouselData.content.channelNumber!=null && !carouselData.content.channelNumber.equals("")){
                    holder.mChannelNumber.setText(carouselData.content.channelNumber+". ");
                    holder.mChannelNumber.setTypeface(mBoldTypeFace);
                }
...
//                        S2 | E1 | Pal Pal Dil Ke Paas
            ...
            if (TextUtils.isEmpty(imageLink)
                ...
                Picasso.get().load(imageLink).placeholder(R.drawable.black) // Your dummy image...
                        .into(holder.mImageViewMovies, new com.squareup.picasso.Callback() {
                            @Override
                            public void onSuccess() {
                               ...
                               // Toast.makeText(mContext, "loaded...= "+carouselData.globalServiceName, Toast.LENGTH_SHORT).show();
                            }
...
//        return type;
    ...
    public class CarouselDataViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TextView viewsCountText,mChannelNumber;
...
//            UiUtil.showFeedback(view, true, R.color.list_item_bkg);
            ...
            mChannelNumber=view.findViewById(R.id.channel_number);
...
//            mImageViewRupeeIcon = (ImageView)view.findViewById(R.id.thumbnail_rupee_icon);
            ...
            fixedAspectRatioRelativeLayout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.small_horizontal_width);
            mImageViewMovies.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.small_horizontal_width);
//
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public void showViewRatingOnThumbnail(AdapterSmallHorizontalCarousel.CarouselDataViewHolder holder, CardData cardData){
