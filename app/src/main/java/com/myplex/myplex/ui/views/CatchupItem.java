...
public class CatchupItem extends GenericListViewCompoment {
    ...
    public static final String IS_CATCH_UP = "isCatchUp";


    public CatchupItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo
    ...
    public static CatchupItem createView(Context context, ViewGroup parent,
        ...
        return new CatchupItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup,  mPageTitle,mBgColor, isFromSearch, globalServiceId);
    }
    ...
    public void bindItemViewHolder(int position) {
      ...
      //  holder.mLayoutViewAll.setVisibility(View.VISIBLE);
       ...
       /* if(isFromSearch)
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterCatchupCarousel) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterSmallHorizontalCarousel = (AdapterCatchupCarousel) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterSmallHorizontalCarousel = new AdapterCatchupCarousel(mContext, carouselInfoData.listCarouselData, holder.mRecyclerViewCarousel);
        }
        if (carouselInfoData != null)
        ...
        if(globalServiceId!=null){
            ...
            params.setMargins((int) mContext.getResources().getDimension(R.dimen.margin_gap_10), (int) mContext.getResources().getDimension(R.dimen.title_image_gap), 0, 0);
    ...
    private class CarouselRequestTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params1) {
         ...
         /*   new MenuDataModel().setPortraitBannerRequest(APIConstants.isPortraitBannerLayout(carouselInfoData)).fetchCarouseldata(mContext, carouselInfoData.name, 1, carouselInfoData.pageSize > 0 ? carouselInfoData.pageSize : APIConstants.PAGE_INDEX_COUNT, isCacheRequest, carouselInfoData.modified_on,new MenuDataModel.CarouselContentListCallback() {
            ...
            EpgCatchUpList.Params params = new EpgCatchUpList.Params( globalServiceId, dateStamp, true);
            EpgCatchUpList channelListEPG = new EpgCatchUpList(params, new APICallback<ChannelsCatchupEPGResponseData>() {
                ...
                public void onResponse(APIResponse<ChannelsCatchupEPGResponseData> response) {
                    if (response != null && response.body() != null && response.body().getResults() != null && response.body().getResults().size() > 0) {
                        addCarouselData(response.body().getResults(), carouselInfoData);
                    }
                }
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    private void showDetailsFragment(CardData carouselData, CarouselInfoData carouselInfoData, int parentPosition, int position) {
    ...
    private void showVODListFragment(CarouselInfoData carouselInfoData, int carouselPositoin) {
        ...
        args.putBoolean(IS_CATCH_UP, true);
        ...
        ((MainActivity) mContext).pushFragment(FragmentVODList.newInstance(args,carouselInfoData.listCarouselData));
    }
