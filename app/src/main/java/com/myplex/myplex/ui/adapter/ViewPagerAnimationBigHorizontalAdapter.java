...
public class ViewPagerAnimationBigHorizontalAdapter extends RecyclerView.Adapter<ViewPagerAnimationBigHorizontalAdapter.ViewHolder> {
    ...
    public ViewPagerAnimationBigHorizontalAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View convertView = mInflater.inflate(R.layout.view_item_pager_anim_big_horizontal, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder mViewHolder, int position) {
        ...
        if (sliderModel!=null&&sliderModel.generalInfo!=null
                &&sliderModel.generalInfo.title.equalsIgnoreCase("No info")){
    ...
    private String getImageLink(CardData movie) {
        ...
        String[] imageTypes = new String[]{APIConstants.COVERPOSTER,APIConstants.IMAGE_TYPE_COVERPOSTER};
