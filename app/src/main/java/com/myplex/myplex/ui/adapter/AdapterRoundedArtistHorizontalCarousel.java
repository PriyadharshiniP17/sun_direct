...
public class AdapterRoundedArtistHorizontalCarousel extends RecyclerView.Adapter<AdapterRoundedArtistHorizontalCarousel.CarouselDataViewHolder>{

    private static final String TAG = AdapterRoundedArtistHorizontalCarousel.class.getSimpleName();
    ...
    public AdapterRoundedArtistHorizontalCarousel(Context context, List<CardData> itemList,RecyclerView recyclerView) {
        mContext = context;
...
//    }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_rounded_artist_horizontal_item, parent, false);
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public final String getImageLink(CardData carouselData) {
        ...
        String[] imageTypes = new String[]{APIConstants.IMAGE_TYPE_THUMBNAIL,APIConstants.IMAGE_TYPE_SQUARE};
