...
public class AdapterLargeHorizontalCarousel extends RecyclerView.Adapter<AdapterLargeHorizontalCarousel.CarouselDataViewHolder>{

    private static final String TAG = AdapterLargeHorizontalCarousel.class.getSimpleName();
    ...
    public AdapterLargeHorizontalCarousel(Context context, List<CardData> itemList,RecyclerView recyclerView) {
        mContext = context;
    ...
    public AdapterLargeHorizontalCarousel(Context context, List<CardData> itemList, boolean isDummyData) {
        mContext = context;
        mListMovies = itemList;
    }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_large_movie_recycler, parent, false);
...
//            mImageViewRupeeIcon = (ImageView)view.findViewById(R.id.thumbnail_rupee_icon);
    ...
    public void showViewRatingOnThumbnail(AdapterLargeHorizontalCarousel.CarouselDataViewHolder holder, CardData cardData){
