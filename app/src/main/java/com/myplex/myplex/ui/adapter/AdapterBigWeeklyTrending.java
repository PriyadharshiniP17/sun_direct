...
public class AdapterBigWeeklyTrending extends RecyclerView.Adapter<AdapterBigWeeklyTrending.CarouselDataViewHolder>{

    private static final String TAG = AdapterBigWeeklyTrending.class.getSimpleName();
...
//    private List<CarouselInfoData> mListCarouselInfo;
    ...
    public AdapterBigWeeklyTrending(Context context, List<CardData> itemList, RecyclerView recyclerView) {
        mContext = context;
    ...
    public AdapterBigWeeklyTrending(Context context, List<CardData> itemList) {
        mContext = context;
        mListMovies = itemList;
    }
...
//    }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_big_weekly_trending, parent, false);
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public void showViewRatingOnThumbnail(AdapterBigWeeklyTrending.CarouselDataViewHolder holder, CardData cardData){
