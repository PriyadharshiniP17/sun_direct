...
public class MediumVerticalItem extends GenericListViewCompoment {
    ...
    AdapterMediumVerticalCarousel adapterMediumVerticalCarosel;

    private Typeface mBoldTypeFace;
    public MediumVerticalItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo,String mMenuGroup, String mPageTitle) {
        super(view);
        this.view = view;
    ...
    public static MediumVerticalItem createView(Context context, ViewGroup parent,
        ...
        return new MediumVerticalItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup, mPageTitle);
    }
...
//            }
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterMediumVerticalCarousel) {
            ...
            adapterMediumVerticalCarosel = (AdapterMediumVerticalCarousel) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterMediumVerticalCarosel = new AdapterMediumVerticalCarousel(mContext, carouselInfoData.listCarouselData,holder.mRecyclerViewCarousel);
        }
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
            ...
            // set the orientation to landscape as we supports only landscape player
