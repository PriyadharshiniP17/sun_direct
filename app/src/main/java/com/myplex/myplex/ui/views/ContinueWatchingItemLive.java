...
import com.myplex.myplex.ui.adapter.ContinueWatchingLiveHorizontal;
...
public class ContinueWatchingItemLive extends GenericListViewCompoment implements ContinueLiveCardPlayerCallback {
    ...
    private ContinueWatchingLiveHorizontal adapterContinueWatchingCarousel = null;
    private Typeface mBoldTypeFace;
    AdapterCarouselInfo adapterCarouselInfo;
    private AdapterCarouselInfo.CallbackListener callbackListener;

    public ContinueWatchingItemLive(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo,/*AdapterCarouselInfo.CallbackListener callbackListener,*/ String menuGroup, String pageTitle) {
        super(view);
        this.view = view;
      ...
      /*  int margin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (int) mContext
        ...
        ((MainActivity) mContext).setContinueLiveCardPlayerCallback(this);
    }

    public static ContinueWatchingItemLive createView(Context context, ViewGroup parent,
        ...
        return new ContinueWatchingItemLive(context, view, carouselInfoData, mRecyclerViewCarouselInfo, menuGroup, pageTitle);
    }
...
//            }
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof ContinueWatchingLiveHorizontal) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterContinueWatchingCarousel = (ContinueWatchingLiveHorizontal) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterContinueWatchingCarousel = new ContinueWatchingLiveHorizontal(mContext, carouselInfoData.listCarouselData, holder.mRecyclerViewCarousel);
        }
        if (carouselInfoData != null)
