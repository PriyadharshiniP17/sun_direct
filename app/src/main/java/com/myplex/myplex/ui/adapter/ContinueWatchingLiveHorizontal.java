...
public class ContinueWatchingLiveHorizontal extends RecyclerView.Adapter<ContinueWatchingLiveHorizontal.CarouselDataViewHolder> {

    private static final String TAG = ContinueWatchingLiveHorizontal.class.getSimpleName();
    ...
    public ContinueWatchingLiveHorizontal(Context context, List<CardData> itemList,RecyclerView recyclerView) {
        mContext = context;
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public void showViewRatingOnThumbnail(ContinueWatchingLiveHorizontal.CarouselDataViewHolder holder, CardData cardData){
