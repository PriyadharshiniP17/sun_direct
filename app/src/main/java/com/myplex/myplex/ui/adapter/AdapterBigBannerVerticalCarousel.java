...
public class AdapterBigBannerVerticalCarousel extends RecyclerView.Adapter<AdapterBigBannerVerticalCarousel.CarouselDataViewHolder> {

    private static final String TAG = AdapterBigBannerVerticalCarousel.class.getSimpleName();
    ...
    public void setLayoutType(String mLayoutType) {
    ...
    public AdapterBigBannerVerticalCarousel(Context context, List<CardData> itemList, RecyclerView recyclerView) {
        mContext = context;
...
//    }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_big_banner_vertical_carousel, parent, false);
...
//            holder.mImageViewProvideLogo.setVisibility(View.GONE);
            ...
            if (mLayoutType != null) {
                if (mLayoutType.equalsIgnoreCase(APIConstants.LAYOUT_TYPE_BIG_BANNER_VERTICAL_LAYOUT)) {
                    holder.firstTitlesLayout.setVisibility(View.VISIBLE);
                    holder.secondTitlesLayout.setVisibility(View.GONE);
                } else if (mLayoutType.equalsIgnoreCase(APIConstants.LAYOUT_TYPE_BIG_BANNER_VERTICAL_LAYOUT_DOUBLE_TITLE)) {
                    holder.firstTitlesLayout.setVisibility(View.GONE);
                    holder.secondTitlesLayout.setVisibility(View.VISIBLE);
                }
            } else {
                holder.firstTitlesLayout.setVisibility(View.VISIBLE);
                holder.secondTitlesLayout.setVisibility(View.GONE);
            ...
            if (mBgColor!=null){
                ...
                holder.mTextViewVODInfo1.setTextColor(mContext.getResources().getColor(R.color.bd_description_light_theme_color));
                holder.mTextViewVODInfo2.setVisibility(mContext.getResources().getColor(R.color.bd_description_light_theme_color));
                holder.titleTv.setVisibility(mContext.getResources().getColor(R.color.medium_small_content_light_theme_text_color));
                holder.subTitleTv.setTextColor(mContext.getResources().getColor(R.color.bd_description_light_theme_color));
            }else {
                holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.title_text_color));
                holder.mTextViewVODInfo1.setTextColor(mContext.getResources().getColor(R.color.color_cccccc));
                holder.mTextViewVODInfo2.setVisibility(mContext.getResources().getColor(R.color.color_cccccc));
                holder.titleTv.setVisibility(mContext.getResources().getColor(R.color.title_text_color));
                holder.subTitleTv.setTextColor(mContext.getResources().getColor(R.color.color_cccccc));
            }
...
//                Picasso.with(mContext).load(APIConstants.getErosNowMusicLogoUrl()).into(holder.mImageViewProvideLogo);
            ...
            if (carouselData.generalInfo != null) {
                if (carouselData.generalInfo.title != null) {
                    ...
                    holder.titleTv.setText(carouselData.generalInfo.title);
                }
                ...
                if (APIConstants.TYPE_PROGRAM.equalsIgnoreCase(carouselData.generalInfo.type)
                    ...
                    holder.subTitleTv.setText(carouselData.globalServiceName);
                }
            }
...
*/
            ...
            if (imageLink == null
                ...
                PicassoUtil.with(mContext).load(placeholderid, holder.mImageViewMovies,placeholderid);
            } else if (imageLink != null) {
                PicassoUtil.with(mContext).load(imageLink, holder.mImageViewMovies,placeholderid);
...
//                    info1 = HomePagerAdapter.getPageLivetv();
            ...
            if(carouselData!=null && carouselData.generalInfo != null && holder.userBadgeImage != null){
...
//        });
    ...
    public int getItemCount() {
        ...
        if (mPageSize > 0 ){
            return Math.min(mListMovies.size(),mPageSize);
        }
...
//        return type;
    ...
    class CarouselDataViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MaterialCardView mRippleOverlay;
        ...
        private LinearLayout firstTitlesLayout;
        private LinearLayout secondTitlesLayout;
...
//            mImageViewRupeeIcon = (ImageView)view.findViewById(R.id.thumbnail_rupee_icon);
            ...
            userBadgeImage = (ImageView)view.findViewById(R.id.content_badge);
            ...
            firstTitlesLayout = view.findViewById(R.id.first_titles_layout);
            secondTitlesLayout = view.findViewById(R.id.secondtitlesLayout);
            titleTv=view.findViewById(R.id.title_tv);
            subTitleTv=view.findViewById(R.id.subtitle_tv);
            mRippleOverlay=view.findViewById(R.id.imageview_thumbnail_layout);
