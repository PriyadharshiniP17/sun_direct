...
public class AdapterCatchupCarousel extends RecyclerView.Adapter<AdapterCatchupCarousel.CarouselDataViewHolder>{

    private static final String TAG = AdapterCatchupCarousel.class.getSimpleName();
...
//    private List<CarouselInfoData> mListCarouselInfo;
    ...
    public AdapterCatchupCarousel(Context context, List<CardData> itemList, RecyclerView recyclerView) {
        mContext = context;
    ...
    public AdapterCatchupCarousel(Context context, List<CardData> itemList) {
        mContext = context;
        mListMovies = itemList;
    }
...
//    }
    ...
    public CarouselDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(mContext).inflate(R.layout.listitem_carousel_catchup, parent, false);
...
//            public void run() {
        ...
        contentTitle=PreferenceManager.getDefaultSharedPreferences(mContext).getString("contentTitle", "");
...
//                Picasso.with(mContext).load(APIConstants.getErosNowMusicLogoUrl()).into(holder.mImageViewProvideLogo);
            ...
            if (carouselData.generalInfo != null) {
                if (carouselData.generalInfo.title != null) {
                    ...
                    if (carouselData.generalInfo._id!=null && contentTitle.equals(carouselData.generalInfo._id)) {
                        holder.mTextViewMovieTitle.setVisibility(View.VISIBLE);
                        holder.mTextViewMovieTitle.setText(carouselData.generalInfo.title);
                        holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.yellow_strip));
                    }
                    holder.mTextViewMovieTitle.setVisibility(View.VISIBLE);
                    holder.mTextViewMovieTitle.setText(carouselData.generalInfo.title);
                ...
                if (carouselData.generalInfo.briefDescription != null
                    ...
                    holder.mTextViewVODInfo1.setTypeface(mBoldTypeFace);
                }
                if (APIConstants.TYPE_PROGRAM.equalsIgnoreCase(carouselData.generalInfo.type)
                    ...
                    holder.mTextViewMovieTitle.setVisibility(View.VISIBLE);
//                    holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.white));
                }
            }
            ...
            if (carouselData != null && carouselData.elapsedTime > 0) {
                ...
                try {
                    ...
                    if (carouselData.generalInfo.type != null) {
                        ...
                        if(carouselData.generalInfo._id!=null && contentTitle.equalsIgnoreCase(carouselData.generalInfo._id)){
                            holder.mTextViewVODInfo1.setTextColor(mContext.getResources().getColor(R.color.yellow_strip));
                        }

                        holder.mTextViewVODInfo1.setTextColor(mContext.getResources().getColor(R.color.white));
                    }
                } catch (Exception e){
                    e.printStackTrace();
                }
...
//                    info1 = HomePagerAdapter.getPageLivetv();
            ...
            if(TextUtils.isEmpty(title)){
                ...
                if(carouselData!=null && carouselData.generalInfo!=null
                        && carouselData.generalInfo._id!=null && contentTitle.equalsIgnoreCase(carouselData.generalInfo._id)) {
                    holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.yellow_strip));
                }
//                holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.white));
                holder.mTextViewMovieTitle.setVisibility(View.VISIBLE);
      ...
      //  holder.mTextViewMovieTitle.setVisibility(View.GONE);
        ...
        holder.mTextViewVODInfo1.setTypeface(mBoldTypeFace);
         if(carouselData != null && carouselData.getTitle() != null && !carouselData.getTitle().isEmpty()) {
             holder.mTextViewMovieTitle.setText(carouselData.getTitle());
             holder.mTextViewMovieTitle.setVisibility(View.VISIBLE);
             holder.mTextViewMovieTitle.setVisibility(View.VISIBLE);
             holder.mTextViewMovieTitle.setText(carouselData.generalInfo.title);
             if(carouselData.generalInfo!=null && carouselData.generalInfo._id!=null && contentTitle.equalsIgnoreCase(carouselData.generalInfo._id)){
                 holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.yellow_strip));
             }
//             holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.white));
         } else {
        ...
        try {
            if(carouselData != null && carouselData.startDate != null && carouselData.endDate != null) {
                ...
                holder.mTextViewVODInfo1.setTextColor(mContext.getResources().getColor(R.color.title_text_color));
                if (carouselData.generalInfo._id!=null && contentTitle.equalsIgnoreCase(carouselData.generalInfo._id)/* && programType1 != CURRENT_PROGRAM*/) {
                    holder.mTextViewVODInfo1.setVisibility(View.VISIBLE);
                    holder.mTextViewVODInfo1.setText(startTime + "-" + endTime);
                    holder.mTextViewVODInfo1.setTextColor(mContext.getResources().getColor(R.color.yellow_strip));
//                    holder.mTextViewMovieTitle.setTextColor(mContext.getResources().getColor(R.color.yellow_strip));
...
//        });
        ...
        updateTitle(carouselData.startDate, holder.mTextViewMovieTitle);
...
//        return type;
    ...
    class CarouselDataViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private FixedAspectRatioRelativeLayout fixedAspectRatioRelativeLayout;
        RelativeLayout imageview_thumbnail_layout;
...
//            mImageViewRupeeIcon = (ImageView)view.findViewById(R.id.thumbnail_rupee_icon);
            ...
            imageview_thumbnail_layout = view.findViewById(R.id.imageview_thumbnail_layout);


                //for portrait
                if(recyclerViewReference!=null){
//                fixedAspectRatioRelativeLayout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.continue_watching_width);
//                mImageViewMovies.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.continue_watching_width);
                    fixedAspectRatioRelativeLayout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_portrait_new_width);
                    mImageViewMovies.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_portrait_new_width);
                    imageview_thumbnail_layout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_portrait_new_width);
                    imageview_thumbnail_layout.getLayoutParams().height = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_portrait_new_height);

                }else {
                    //for landscape
                    fixedAspectRatioRelativeLayout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_landscape_width);
                    mImageViewMovies.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_landscape_width);
                    imageview_thumbnail_layout.getLayoutParams().width = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_landscape_width);
                    imageview_thumbnail_layout.getLayoutParams().height = itemView.getResources().getDimensionPixelSize(R.dimen.catchup_landscape_height);
                }
...
//                carouselData.generalInfo.deepLink = "http://www.sonyliv.com/details/live/5230736998001/Santhiya-Sehaj-Path-:-Giani-Jagtar-Singh-:-Epi-112";
    ...
    public void showViewRatingOnThumbnail(AdapterCatchupCarousel.CarouselDataViewHolder holder, CardData cardData){
    ...
    private void updateTitle(String startDateStr, TextView textView){
        long startTime = 0;
        try {
            if(startDateStr!=null){
                startTime = Util.parseXsDateTime(startDateStr);
