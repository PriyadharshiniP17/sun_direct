...
public class SimilarContentViewComponent extends GenericListViewCompoment{
    ...
    public SimilarContentViewComponent(Context mContext, List<DetailsViewContent.DetailsViewDataItem> data, View view,
    ...
    public static SimilarContentViewComponent createView(Context context, List<DetailsViewContent.DetailsViewDataItem> data, ViewGroup parent, CardDetailViewFactory.CardDetailViewFactoryListener listener) {
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_carouselinfo,
                parent, false);
        SimilarContentViewComponent briefDescriptionComponent = new SimilarContentViewComponent(context, data, view, listener);
