...
import com.myplex.myplex.ui.adapter.AdapterExtraSmallCoverITem;
...
public class ExtraSmallCoverItem extends GenericListViewCompoment {
    ...
    AdapterExtraSmallCoverITem adapterSmallHorizontalCarousel = null;
    String mBgColor;
    private boolean isFromSearch;
    String globalServiceId;
    private Typeface mBoldTypeFace;

    public ExtraSmallCoverItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo
    ...
    public static ExtraSmallCoverItem createView(Context context, ViewGroup parent,
        ...
        return new ExtraSmallCoverItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup,  mPageTitle,mBgColor, isFromSearch,globalServiceId);
    }
    ...
    public void bindItemViewHolder(int position) {
      ...
      //  holder.mLayoutViewAll.setVisibility(View.VISIBLE);
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterExtraSmallCoverITem) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterSmallHorizontalCarousel = (AdapterExtraSmallCoverITem) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterSmallHorizontalCarousel = new AdapterExtraSmallCoverITem(mContext, carouselInfoData.listCarouselData, holder.mRecyclerViewCarousel);
        }
        if (carouselInfoData != null)
