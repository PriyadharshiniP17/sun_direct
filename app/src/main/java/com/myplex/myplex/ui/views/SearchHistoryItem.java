...
import com.myplex.myplex.ui.adapter.AdapterMediumVerticalCarousel;
import com.myplex.myplex.ui.adapter.AdapterSearchHistoryCarousell;
...
public class SearchHistoryItem extends GenericListViewCompoment {
    ...
    AdapterSearchHistoryCarousell adapterMediumVerticalCarosel;
    private Typeface mBoldTypeFace;

    public SearchHistoryItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo, String mMenuGroup, String mPageTitle) {
        super(view);
        this.view = view;
        ...
        mHorizontalMoviesDivieder = new VerticalSpaceItemDecoration((int) mContext
    ...
    public static SearchHistoryItem createView(Context context, ViewGroup parent,
        ...
        return new SearchHistoryItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup, mPageTitle);
    }
    ...
    public void bindItemViewHolder(int position) {
        ...
        Log.e("Recent Search","Search"+str1);
      ...
      /*  holder.mClearTextTitle.setVisibility(View.VISIBLE);
        holder.mClearTextTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                notifyItemRemoved(carouselInfoData);
                PrefUtils.getInstance().setString("PREF_RECENT_SEARCH", "");
            }
        });*/
...
//            }
        ...
        adapterMediumVerticalCarosel = null;
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterMediumVerticalCarousel) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterMediumVerticalCarosel = (AdapterSearchHistoryCarousell) holder.mRecyclerViewCarousel.getTag();
           // adapterMediumVerticalCarosel.setData(carouselInfoData.listCarouselData);
        } else {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " create adapter");
            adapterMediumVerticalCarosel = new AdapterSearchHistoryCarousell(mContext, recentSearchList,holder.mRecyclerViewCarousel);
        }
        adapterMediumVerticalCarosel = new AdapterSearchHistoryCarousell(mContext, recentSearchList,holder.mRecyclerViewCarousel);
        LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " requestState- " + carouselInfoData.requestState);
        adapterMediumVerticalCarosel.showTitle(carouselInfoData.showTitle);
        ...
        holder.mRecyclerViewCarousel.setTag(adapterMediumVerticalCarosel);
        adapterMediumVerticalCarosel.setOnItemClickListenerWithMovieData(mOnItemClickListenerMovies);
        adapterMediumVerticalCarosel.setParentViewHolder(holder);
        adapterMediumVerticalCarosel.setParentPosition(position);
        adapterMediumVerticalCarosel.setCarouselInfoData(carouselInfoData.name, carouselInfoData.pageSize);
        adapterMediumVerticalCarosel.isContinueWatchingSection(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_CONTINUE_WATCHING.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterMediumVerticalCarosel.isGenericLayout(carouselInfoData.layoutType != null
                && APIConstants.LAYOUT_TYPE_HORIZONTAL_LIST_GENERIC_ITEM.equalsIgnoreCase(carouselInfoData.layoutType));
        adapterMediumVerticalCarosel.setRemoveItemListener(mOnItemRemovedListener);
        holder.mRecyclerViewCarousel.setAdapter(adapterMediumVerticalCarosel);
