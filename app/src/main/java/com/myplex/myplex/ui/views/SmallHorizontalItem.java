...
public class SmallHorizontalItem extends GenericListViewCompoment {
    ...
    AdapterSmallHorizontalCarousel adapterSmallHorizontalCarousel = null;
    String mBgColor;
    private boolean isFromSearch;
    String globalServiceId;
    private Typeface mBoldTypeFace;
    public SmallHorizontalItem(Context mContext, View view, List<CarouselInfoData> mListCarouselInfo, RecyclerView mRecyclerViewCarouselInfo
...
//        mHorizontalMoviesDivieder = new HorizontalItemDecorator(25, (int) mContext.getResources().getDimension(R.dimen.margin_gap_4) - 25);
    ...
    public static SmallHorizontalItem createView(Context context, ViewGroup parent,
        ...
        return new SmallHorizontalItem(context, view, carouselInfoData, mRecyclerViewCarouselInfo, mMenuGroup,  mPageTitle,mBgColor, isFromSearch, globalServiceId);
    }
    ...
    public void bindItemViewHolder(int position) {
      ...
      /*  if(isFromSearch)
        ...
        if (holder.mRecyclerViewCarousel.getTag() instanceof AdapterSmallHorizontalCarousel) {
            LoggerD.debugLogAdapter("carousel title- " + carouselInfoData.title + " getTag");
            adapterSmallHorizontalCarousel = (AdapterSmallHorizontalCarousel) holder.mRecyclerViewCarousel.getTag();
            ...
            adapterSmallHorizontalCarousel = new AdapterSmallHorizontalCarousel(mContext, carouselInfoData.listCarouselData, holder.mRecyclerViewCarousel);
        }
        if (carouselInfoData != null)
    ...
    public final ItemClickListenerWithData mOnItemClickListenerMovies = new ItemClickListenerWithData() {
        ...
        public void onClick(View view, int position, int parentPosition, final CardData carouselData) {
            ...
            CarouselInfoData carouselInfoData = parentPosition >= 0 ? (parentPosition < mListCarouselInfo.size() ? mListCarouselInfo.get(parentPosition) : null) : null;
