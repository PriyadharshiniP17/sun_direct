 ...
 *
 * BaseTransformer implement {@link com.myplex.myplex.animationviewpager.ViewPagerEx.PageTransformer}
 * which is just same as {@link ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.myplex.myplex.animationviewpager.ViewPagerEx}
...
public abstract class BaseTransformer implements ViewPagerEx.PageTransformer {
    ...
    /**
     * Called each {@link ViewPagerEx.PageTransformer#transformPage(View, float)}.
     *
     * @param view
     * @param position
     */
    ...
    public void transformPage(View view, float position) {
        LoggerD.debugLog("BaseTransformer: transformPage");
    ...
    protected void onPreTransform(View view, float position) {
        LoggerD.debugLog("BaseTransformer: onPreTransform");
