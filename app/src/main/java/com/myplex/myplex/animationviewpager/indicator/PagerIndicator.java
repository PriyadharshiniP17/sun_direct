...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        int shape = attributes.getInt(R.styleable.PagerIndicator_shape, Shape.Rectangle.ordinal());
        ...
        mDefaultSelectedColor = attributes.getColor(R.styleable.PagerIndicator_selected_color, UiUtil.getColor(mContext, R.color.red_highlight_color));
        mDefaultUnSelectedColor = attributes.getColor(R.styleable.PagerIndicator_unselected_color, UiUtil.getColor(mContext, R.color.white_70));

        mDefaultSelectedWidth = attributes.getDimension(R.styleable.PagerIndicator_selected_width,(int)pxFromDp(18));
        mDefaultSelectedHeight = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_selected_height,(int)pxFromDp(2));

        mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_width,(int)pxFromDp(18));
        mDefaultUnSelectedHeight = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_unselected_height,(int)pxFromDp(2));
/*

        if(mIndicatorShape == Shape.Oval){
