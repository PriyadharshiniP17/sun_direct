...
public abstract class BaseSliderView {
    ...
    public BaseSliderView setUrl(String imageUrl) {
    ...
    public void setImageViewBitmap(ImageView targetImageView) {
    ...
    protected void bindEventAndShow(final View v, final ImageView targetImageView) {
        ...
        if (mBitmap != null) {
            setImageViewBitmap(targetImageView);
        }
