...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mUnselectedColor = res.getColor(R.color.default_title_unselected_color);
       ...
       // mUnselectedColor = a.getColor(R.styleable.TitlePageIndicator_unselectedColor,)
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int rightAdd = getResources().getInteger(R.integer.epg_counter_right);
        final int left = getLeft()- rightAdd;
        final float leftClip = left + mClipPadding;
        final int width = getWidth();
        int height = getHeight();
        final int right =  width-35;
        ...
        for (int i = 0; i < count; i++) {
            ...
            if ((bound.left > left && bound.left < right) || (bound.right > left && bound.right < right)) {
                ...
                if (currentPage && currentSelected) {
                    ...
                    mPaintText.setColor(mUnselectedColor);
                   // mPaintText.setAlpha((int) ((mColorSelected >>> 24) * selectedPercent));
                    canvas.drawText(pageTitle, 0, pageTitle.length(), bound.left, bound.bottom + mTopPadding, mPaintText);
                }
            }
